...
import me.alphamode.forgetags.Tags.Fluids;
...
public class MaterialisRecipes extends FabricRecipeProvider implements IMaterialRecipeHelper, IToolRecipeHelper, ISmelteryRecipeHelper, ICommonRecipeHelper {

	public MaterialisRecipes(FabricDataGenerator gen) {
		super(gen);
	}
	...
	public void generateRecipes(Consumer<FinishedRecipe> consumer) {
		...
		castCreation(withCondition(consumer, tagConditionDomain("c", "inlays")), MaterialisItemTags.INLAYS, MaterialisResources.INLAY_CAST, castFolder);
		tagCasting(consumer, TinkerFluids.moltenPewter, (int) FluidValues.INGOT * 2, MaterialisResources.INLAY_CAST, "inlays/pewter", castingFolder + "pewter_inlay", true);
		tagCasting(consumer, MaterialisResources.ARCANE_GOLD_FLUID.OBJECT, (int) FluidValues.INGOT * 2, MaterialisResources.INLAY_CAST, "inlays/arcane_gold", castingFolder + "arcane_gold_inlay", true);

		MeltingRecipeBuilder.melting(Ingredient.of(MaterialisItemTags.PEWTER_INLAY), TinkerFluids.moltenPewter.get(), FluidValues.INGOT * 2, 1.5f).save(withCondition(consumer, tagConditionDomain("c", "inlays/pewter")), modResource(meltingFolder + "pewter_inlay"));
		MeltingRecipeBuilder.melting(Ingredient.of(MaterialisItemTags.ARCANE_GOLD_INLAY), MaterialisResources.ARCANE_GOLD_FLUID.FLUID.get(), FluidValues.INGOT * 2, 1.5f).save(withCondition(consumer, tagConditionDomain("c", "inlays/arcane_gold")), modResource(meltingFolder + "arcane_gold_inlay"));

		MeltingRecipeBuilder.melting(ItemNameIngredient.from(new ResourceLocation("eidolon", "pewter_blend")), TinkerFluids.moltenPewter.get(), FluidValues.INGOT, 1.0f).save(withCondition(consumer, DefaultResourceConditions.allModsLoaded("eidolon")), modResource(meltingFolder + "pewter_blend"));
		...
		toolMelting(withCondition(consumer, DefaultResourceConditions.allModsLoaded("aquaculture")), new NameFluid("neptunium", MaterialisResources.NEPTUNIUM_FLUID.FLUID.get()),
		...
		multipleToolMelting(withCondition(consumer, DefaultResourceConditions.allModsLoaded("aquaculture")), "aquaculture",
				new NameFluid[] {
		...
		multipleToolMelting(withCondition(consumer, DefaultResourceConditions.allModsLoaded("mysticalworld")), "mysticalworld",
				new NameFluid[] {
		...
		Consumer<FinishedRecipe> industrialForegoingLoaded = withCondition(consumer, DefaultResourceConditions.allModsLoaded("industrialforegoing"));
		...
		MeltingRecipeBuilder.melting(ItemNameIngredient.from(new ResourceLocation("undergarden", "utheric_shard")), MaterialisResources.UTHERIUM_FLUID.FLUID.get(), FluidValues.NUGGET, 1.0f).save(withCondition(consumer, DefaultResourceConditions.allModsLoaded("undergarden")), modResource(meltingFolder + "utheric_shard"));
		EntityMeltingRecipeBuilder.melting(EntityIngredient.of(CleansingModifier.rotspawnTag), new FluidStack(MaterialisResources.UTHERIUM_FLUID.FLUID.get(), FluidValues.NUGGET / 8)).save(withCondition(consumer, DefaultResourceConditions.allModsLoaded("undergarden")));
		multipleToolMelting(withCondition(consumer, DefaultResourceConditions.allModsLoaded("undergarden")), "undergarden",
				new NameFluid[] {
				...
				new ToolValue("_leggings", 7),
				new ToolValue("_boots", 4));
		toolMelting(withCondition(consumer, DefaultResourceConditions.allModsLoaded("undergarden")), new NameFluid("forgotten_metal", MaterialisResources.CLOGGRUM_FLUID.FLUID.get(), new FluidStack(MaterialisResources.FORGOTTEN_FLUID.FLUID.get(), FluidValues.INGOT), true),
		...
		toolMelting(withCondition(consumer, DefaultResourceConditions.allModsLoaded("undergarden")), new NameFluid("cloggrum", MaterialisResources.CLOGGRUM_FLUID.FLUID.get()),
		...
		multipleToolMelting(withCondition(consumer, DefaultResourceConditions.allModsLoaded("mekanismtools")), "mekanismtools",
				new NameFluid[] {
		...
		//psi stuff
		Consumer<FinishedRecipe> psiLoaded = withCondition(consumer, DefaultResourceConditions.allModsLoaded("psi"));
		...
		toolMelting(withCondition(consumer, DefaultResourceConditions.and(DefaultResourceConditions.allModsLoaded("psi"), DefaultResourceConditions.not(DefaultResourceConditions.allModsLoaded("magipsi")))), new NameFluid("psimetal", MaterialisResources.PSIMETAL_FLUID.FLUID.get(), new FluidStack(TinkerFluids.moltenIron.get(), FluidValues.INGOT * 2), false),
				new ToolValue("psi:psimetal_axe", 2),
				new ToolValue("psi:psimetal_pickaxe", 2),
				new ToolValue("psi:psimetal_shovel", 1));
		toolMelting(withCondition(consumer, DefaultResourceConditions.and(DefaultResourceConditions.allModsLoaded("psi"), DefaultResourceConditions.not(DefaultResourceConditions.allModsLoaded("magipsi")))), new NameFluid("psimetal", MaterialisResources.PSIMETAL_FLUID.FLUID.get(), new FluidStack(TinkerFluids.moltenIron.get(), FluidValues.INGOT), false),
				new ToolValue("psi:psimetal_sword", 1));
		toolMelting(withCondition(consumer, DefaultResourceConditions.allModsLoaded("magipsi")), new NameFluid("psimetal_magical", MaterialisResources.PSIMETAL_FLUID.FLUID.get(), new FluidStack(TinkerFluids.moltenGold.get(), FluidValues.INGOT), false),
				new ToolValue("psi:psimetal_axe", 2),
				new ToolValue("psi:psimetal_pickaxe", 2),
				new ToolValue("psi:psimetal_shovel", 1),
				new ToolValue("psi:psimetal_sword", 1));
		...
		toolMelting(withCondition(consumer, DefaultResourceConditions.allModsLoaded("occultism")), new NameFluid("iesnium", MaterialisResources.IESNIUM_FLUID.FLUID.get()),
		...
		multipleToolMelting(withCondition(consumer, DefaultResourceConditions.allModsLoaded("botania")), "botania",
				new NameFluid[] {
				...
				new ToolValue("_leggings", 7),
				new ToolValue("_boots", 4));
		toolMelting(withCondition(consumer, DefaultResourceConditions.allModsLoaded("botania")), new NameFluid("manasteel", MaterialisResources.MANASTEEL_FLUID.FLUID.get()),
				new ToolValue("botania:manasteel_pick", 3));
		toolMelting(withCondition(consumer, DefaultResourceConditions.allModsLoaded("botania")), new NameFluid("elementium", MaterialisResources.ELEMENTIUM_FLUID.FLUID.get()),
				new ToolValue("botania:elementium_pickaxe", 3));
		toolMelting(withCondition(consumer, DefaultResourceConditions.allModsLoaded("botania")), new NameFluid("terrasteel", MaterialisResources.MANASTEEL_FLUID.FLUID.get(), new FluidStack(MaterialisResources.TERRASTEEL_FLUID.FLUID.get(), FluidValues.INGOT * 3), true),
		...
		toolMelting(withCondition(consumer, DefaultResourceConditions.allModsLoaded("botania")), new NameFluid("terrasteel", MaterialisResources.TERRASTEEL_FLUID.FLUID.get()),
		...
		//MeltingRecipeBuilder.melting(ItemNameIngredient.from(new ResourceLocation("mythicbotany", "alfsteel_armor_upgrade")), MaterialisResources.ALFSTEEL_FLUID.FLUID.get(), FluidValues.INGOT * 2, 1.0f).save(withCondition(consumer, DefaultResourceConditions.allModsLoaded("mythicbotany")), modResource(meltingFolder + "alfsteel_double_ingot"));
		toolMelting(withCondition(consumer, DefaultResourceConditions.allModsLoaded("mythicbotany")), new NameFluid("alfsteel", MaterialisResources.TERRASTEEL_FLUID.FLUID.get(), new FluidStack(MaterialisResources.ALFSTEEL_FLUID.FLUID.get(), FluidValues.INGOT), true),
		...
		materialRecipe(withCondition(consumer, DefaultResourceConditions.itemTagsPopulated(MaterialisItemTags.ROSE_QUARTZ_MATERIAL)), MaterialisMaterials.roseQuartz, Ingredient.of(MaterialisItemTags.ROSE_QUARTZ_MATERIAL), 1, 1, materialFolder + "rose_quartz");
		...
		materialRecipe(withCondition(consumer, DefaultResourceConditions.itemTagsPopulated(MaterialisItemTags.PLASTIC_MATERIAL)), MaterialisMaterials.plastic, Ingredient.of(MaterialisItemTags.PLASTIC_MATERIAL), 1, 1, materialFolder + "plastic");
		...
		materialRecipe(withCondition(consumer, DefaultResourceConditions.allModsLoaded("botania")), MaterialisMaterials.livingwood, Ingredient.of(getItemTag("botania", "livingwood_logs")), 1, 1, materialFolder + "livingwood_log");
		materialRecipe(withCondition(consumer, DefaultResourceConditions.allModsLoaded("botania")), MaterialisMaterials.livingwood, ItemNameIngredient.from(new ResourceLocation("botania", "livingwood_planks")), 1, 4, materialFolder + "livingwood_plank");
		materialRecipe(withCondition(consumer, DefaultResourceConditions.allModsLoaded("botania")), MaterialisMaterials.livingwood, ItemNameIngredient.from(new ResourceLocation("botania", "livingwood_twig")), 2, 1, materialFolder + "livingwood_twig");
		materialRecipe(withCondition(consumer, DefaultResourceConditions.allModsLoaded("botania")), MaterialisMaterials.dreamwood, Ingredient.of(getItemTag("botania", "dreamwood_logs")), 1, 1, materialFolder + "dreamwood_log");
		materialRecipe(withCondition(consumer, DefaultResourceConditions.allModsLoaded("botania")), MaterialisMaterials.dreamwood, ItemNameIngredient.from(new ResourceLocation("botania", "dreamwood_planks")), 1, 1, materialFolder + "dreamwood/plank");
		materialRecipe(withCondition(consumer, DefaultResourceConditions.allModsLoaded("botania")), MaterialisMaterials.dreamwood, ItemNameIngredient.from(new ResourceLocation("botania", "dreamwood_twig")), 2, 1, materialFolder + "dreamwood/twig");
		...
		materialComposite(withCondition(consumer, DefaultResourceConditions.and(tagCondition("ingots/cloggrum"), tagCondition("ingots/forgotten_metal"))), MaterialisMaterials.cloggrum, MaterialisMaterials.forgottenMetal, MaterialisResources.FORGOTTEN_FLUID.OBJECT, false, FluidValues.NUGGET * 3, compositeFolder);
		...
		.save(withCondition(consumer, DefaultResourceConditions.and(tagCondition("ingots/cloggrum"), tagCondition("ingots/forgotten_metal"))), modResource(materialFolder + "melting/forgotten_metal"));
		...
		materialComposite(withCondition(consumer, DefaultResourceConditions.allModsLoaded("mythicbotany")), MaterialisMaterials.terrasteel, MaterialisMaterials.alfsteel, MaterialisResources.ALFSTEEL_FLUID.OBJECT, false, FluidValues.NUGGET * 3, compositeFolder);
		...
		.save(withCondition(consumer, DefaultResourceConditions.allModsLoaded("mythicbotany")), modResource(materialFolder + "melting/alfsteel"));
		...
		.save(withCondition(consumer, DefaultResourceConditions.allModsLoaded("eidolon")), prefix(MaterialisModifiers.reapingModifier.getId(), modifierFolder));

		OverslimeModifierRecipeBuilder.modifier(Ingredient.of(MaterialisItemTags.PINK_SLIME), 70)
		.save(withCondition(consumer, DefaultResourceConditions.allModsLoaded("industrialforegoing")), prefix(TinkerModifiers.overslime.getId(), modifierFolder));
...
//		.save(ConsumerWrapperBuilder.wrap(MaterialisResources.runeModifierSerializer.get()).addCondition(DefaultResourceConditions.allModsLoaded("quark")).build(consumer), prefix(MaterialisModifiers.runedModifier.getId(), modifierFolder));
		...
		.addInput(getItemTag("c", "gears/nickel"))
		...
		.save(withCondition(consumer, DefaultResourceConditions.allModsLoaded("thermal")), prefix(MaterialisModifiers.thermalWrenchingModifier.getId(), modifierFolder));
		...
		.save(withCondition(consumer, DefaultResourceConditions.allModsLoaded("create")), prefix(MaterialisModifiers.createWrenchingModifier.getId(), modifierFolder));

		ModifierRecipeBuilder.modifier(MaterialisModifiers.immersiveWrenchingModifier)
		.setTools(interactableWithDurability)
		.addInput(getItemTag("c", "plates/copper"))
		...
		.save(withCondition(consumer, DefaultResourceConditions.allModsLoaded("immersiveengineering")), prefix(MaterialisModifiers.immersiveWrenchingModifier.getId(), modifierFolder));
		...
		.save(withCondition(consumer, DefaultResourceConditions.allModsLoaded("prettypipes")), prefix(MaterialisModifiers.pipeWrenchingModifier.getId(), modifierFolder));

		ModifierRecipeBuilder.modifier(MaterialisModifiers.psionizingRadiationModifier)
		.addInput(getItemTag("c", "ingots/psimetal"))
		.addInput(SizedIngredient.of(ItemNameIngredient.from(new ResourceLocation("psi", "cad_socket_basic"))))
		.addInput(getItemTag("c", "ingots/psimetal"))
		.addInput(getItemTag("c", "gems/psigem"))
		.addInput(getItemTag("c", "gems/psigem"))
		...
		.addInput(getItemTag("c", "ingots/ebony_psimetal"))
		.addInput(getItemTag("c", "gems/psigem"))
		.addInput(getItemTag("c", "ingots/ivory_psimetal"))
		...
		.save(ConsumerWrapperBuilder.wrap(MaterialisResources.colorizerModifierSerializer.get()).addCondition(DefaultResourceConditions.allModsLoaded("psi")).build(consumer), prefix(MaterialisModifiers.colorizedModifier.getId(), modifierFolder));
		 */
		ConditionJsonProvider capacitorIsUseful = DefaultResourceConditions.or(DefaultResourceConditions.allModsLoaded("draconicevolution"), DefaultResourceConditions.allModsLoaded("redstone_arsenal"));

		ModifierRecipeBuilder.modifier(MaterialisModifiers.capacitorModifier)
		.addInput(getItemTag("c", "ingots/lead"))
		...
		.save(withCondition(consumer, DefaultResourceConditions.and(capacitorIsUseful, DefaultResourceConditions.allModsLoaded("thermal"))), prefix(MaterialisModifiers.capacitorModifier.getId(), modifierFolder + "thermal_"));

		ModifierRecipeBuilder.modifier(MaterialisModifiers.capacitorModifier)
		.addInput(getItemTag("c", "ingots/lead"))
		.addInput(SizedIngredient.of(ItemNameIngredient.from(new ResourceLocation("immersiveengineering", "wirecoil_copper"))))
		.addInput(getItemTag("c", "dusts/redstone"))
		.setTools(TinkerTags.Items.MODIFIABLE)
		.setMaxLevel(5)
		.setSlots(SlotType.UPGRADE, 1)
		.save(withCondition(consumer, DefaultResourceConditions.and(capacitorIsUseful, DefaultResourceConditions.allModsLoaded("immersiveengineering"))), prefix(MaterialisModifiers.capacitorModifier.getId(), modifierFolder + "immersiveengineering_"));

		ModifierRecipeBuilder.modifier(MaterialisModifiers.capacitorModifier)
		.addInput(SizedIngredient.of(ItemNameIngredient.from(new ResourceLocation("mekanism", "alloy_infused"))))
		.addInput(getItemTag("c", "ingots/gold"))
		.addInput(SizedIngredient.of(ItemNameIngredient.from(new ResourceLocation("mekanism", "alloy_infused"))))
		.setTools(TinkerTags.Items.MODIFIABLE)
		.setMaxLevel(5)
		.setSlots(SlotType.UPGRADE, 1)
		.save(withCondition(consumer, DefaultResourceConditions.and(capacitorIsUseful, DefaultResourceConditions.allModsLoaded("mekanism"))), prefix(MaterialisModifiers.capacitorModifier.getId(), modifierFolder + "mekanism_"));
		...
		.save(ConsumerWrapperBuilder.wrap(MaterialisResources.sensorModifierSerializer.get()).addCondition(DefaultResourceConditions.allModsLoaded("psi")).build(consumer), prefix(MaterialisModifiers.psionizingRadiationModifierSensor.getId(), modifierFolder));
		...
		.save(withCondition(consumer, DefaultResourceConditions.allModsLoaded("create")), prefix(MaterialisModifiers.engineersGogglesModifier.getId(), modifierFolder));
		...
		.save(withCondition(consumer, DefaultResourceConditions.allModsLoaded("occultism")), prefix(MaterialisModifiers.otherworldGogglesModifier.getId(), modifierFolder));
		...
		.save(withCondition(consumer, DefaultResourceConditions.allModsLoaded("ars_nouveau")), wrap(MaterialisModifiers.reactiveModifier.getId(), modifierFolder, "_level_1"));
		ModifierRecipeBuilder.modifier(MaterialisModifiers.reactiveModifier)
		.setTools(TinkerTags.Items.MODIFIABLE)
		...
		.save(withCondition(consumer, DefaultResourceConditions.allModsLoaded("ars_nouveau")), wrap(MaterialisModifiers.reactiveModifier.getId(), modifierFolder, "_level_2"));
		ModifierRecipeBuilder.modifier(MaterialisModifiers.reactiveModifier)
		.setTools(TinkerTags.Items.MODIFIABLE)
		...
		.addInput(getItemTag("c", "ingots/cobalt"))
		...
		.save(withCondition(consumer, DefaultResourceConditions.allModsLoaded("ars_nouveau")), wrap(MaterialisModifiers.reactiveModifier.getId(), modifierFolder, "_level_3"));
		ModifierRecipeBuilder.modifier(MaterialisModifiers.reactiveModifier)
		.setTools(TinkerTags.Items.MODIFIABLE)
		.addInput(Tags.Items.ENDER_PEARLS)
		...
		.save(withCondition(consumer, DefaultResourceConditions.allModsLoaded("ars_nouveau")), wrap(MaterialisModifiers.reactiveModifier.getId(), modifierFolder, "_level_4"));
	...
	public void blockIngotNuggetCompression(Consumer<FinishedRecipe> consumer, String name, Item block, Item ingot, Item nugget) {
		ConditionalRecipe.builder().addCondition(TrueCondition.INSTANCE).addRecipe(
				ShapedRecipeBuilder.shaped(block, 1)
				.pattern("XXX")
				.pattern("XYX")
				.pattern("XXX")
				.define('X', TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation("c", "ingots/" + name)))
				.define('Y', ingot)
				.group("")
		...
		ConditionalRecipe.builder().addCondition(TrueCondition.INSTANCE).addRecipe(
				...
				.pattern("XYX")
				.pattern("XXX")
				.define('X', TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation("c", "nuggets/" + name)))
				.define('Y', nugget)
				.group("")
	...
	private void plateTexture(Consumer<FinishedRecipe> consumer, Ingredient tool, MaterialId material, String tag, boolean optional, String folder) {
		Ingredient ingot = Ingredient.of(TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation("c", tag)));
		if (optional) {
	...
	protected static ConditionJsonProvider tagConditionDomain(String domain, String name) {
		return DefaultResourceConditions.itemTagsPopulated(TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation(domain, name)));
	}
